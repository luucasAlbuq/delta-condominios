...
public abstract class Repository<Entidade> {
	...
	/**
	 * @return Retorna a classe da entidade no qual o repositório vai fazer as
	 *         operações
	 */
	...
	public List<Entidade> findByAttributeName(String attributeName,
		...
		String hql = "FROM " + getEntityClass().getName() + " c" + " WHERE c."
	...
	public List<Entidade> findAll(int pageNumber, int pageSize) {
		...
		Root<Entidade> from = criteriaQuery.from(getEntityClass());
